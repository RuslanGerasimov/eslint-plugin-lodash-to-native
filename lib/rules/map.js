...
module.exports = {
    ...
    create: function(context) {
        ...
        function getTheFirstIf(node) {
            const ifStatement = getParentNodeByType(node, 'ConditionalExpression') || getParentNodeByType(node, 'IfStatement');
            return ifStatement && ifStatement.parent && (ifStatement.parent.type === 'IfStatement' || ifStatement.parent.type === 'ConditionalExpression') ? getTheFirstIf(ifStatement.parent) : ifStatement;
        }
